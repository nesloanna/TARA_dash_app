...
df = pd.read_csv(
    "https://github.com/nesloanna/TARA_deploy_app/releases/download/data/Tara_BMN_Cleaned.csv")
...
sidebar = html.Div([
    html.H5("Filters"),
    html.Hr(),
    html.P('Color points by category:', style=h6_style),
    dbc.RadioItems(
        options=[
    ...
    dbc.Container(
        dcc.RangeSlider(
            ...
            # vertical=False,
        ), style={'marginLeft': '-20px', 'marginRight': '-20px', 'padding': '0px',
                  'width': '120%'},
    ),
    ...
    html.Div([
        html.P("Filtered data:",
               style={'marginBottom': 0, 'marginLeft': 0,
                      'marginTop': 25, 'font-size': '13px'}),
        html.Div(id='filtered-count', style={
            'marginBottom': 0, 'font-size': '13px',
            'marginTop': 25,
...
custom_colors = ['#5F676C', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#edbf33',
                 '#e377c2', '#8BC34A', '#1f77b4', '#0bb4ff', '#7f7f7f', '#bcbd22', '#17becf',
